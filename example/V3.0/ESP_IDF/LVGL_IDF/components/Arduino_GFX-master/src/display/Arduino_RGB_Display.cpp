...
uint16_t *Arduino_RGB_Display::getFramebuffer2()
{
  return _rgbpanel->getFrameBuffer2();
}

esp_lcd_panel_handle_t Arduino_RGB_Display::getRgbPanelHandle()
{
  return _rgbpanel->getPanelHandle();
}
